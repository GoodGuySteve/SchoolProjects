...
public class Game 
{
 ...
 public void clickEnabled(boolean b){
	 lastClick = !b;
 }
    ...
    public void processClick( int x, int y )      
 {
     ...
     if (!critterList.isEmpty()){
        for (Critter critter : critterList){
            if (critter instanceof SquareCritter || critter instanceof PolyCritter){
            ...
            else {  //if WOW critter, arc critter, or round critter
 ...
 // Subclass Critter whose color is randomly chosen each time it is drawn
 ...
 private class ArcCritter extends Critter
 {
    ...
    public void draw(Graphics graphics){
        graphics.setColor(critterColor);
        graphics.fillArc(x, y, 60, 60, 30, 300);
    }
 ...
 private class PolyCritter extends Critter
 {
    ...
    public void draw(Graphics graphics){
        graphics.setColor(critterColor);
        int[] xPoints = {x, x+30, x+60};
        int[] yPoints = {y+60, y, y+60};
        graphics.fillPolygon(xPoints, yPoints, 3);
        yPoints = new int[]{y, y+60, y};
        graphics.fillPolygon(xPoints, yPoints, 3);
    }
